                            ...
                            html.button(
                                {
                                    ...
                                    'id': 'rps/vs-bot-success-tab',
                                    'data-bs-toggle': 'tab',
                                    'data-bs-target': '#rps/vs-bot-success-tab-pane',
                                    'type': 'button',
                                    'role': 'tab',
                                    'aria-controls': 'rps/vs-bot-success-tab-pane',
                                    'aria-selected': 'true'
                                },
                                'Response Success'
                            )
                            ...
                            html.button(
                                {
                                    ...
                                    'id': 'rps/vs-bot-failed-tab',
                                    'data-bs-toggle': 'tab',
                                    'data-bs-target': '#rps/vs-bot-failed-tab-pane',
                                    'type': 'button',
                                    'role': 'tab',
                                    'aria-controls': 'rps/vs-bot-failed-tab-pane',
                                    'aria-selected': 'true'
                                },
                                'Response Failed'
                            )
                        ...
                        html.div(
                            {
                                ...
                                'id': 'rps/vs-bot-success-tab-pane',
                                'role': 'tabpanel',
                                'aria-labelledby': 'rps/vs-bot-success-tab',
                                'tabindex': '0'
                            },
                            html.pre(
                                {
                        ...
                        html.div(
                            {
                                ...
                                'id': 'rps/vs-bot-failed-tab-pane',
                                'role': 'tabpanel',
                                'aria-labelledby': 'rps/vs-bot-failed-tab',
                                'tabindex': '0'
                            },
                            html.pre(
                                {
