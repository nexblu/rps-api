...
from reactpy import component, html, use_state, use_location, use_effect
...
@component
def component_contact() -> Component:
...
document.title = 'Contact Ditttt RPS API';
'''
        ),
        (
            html.style(
            ...
            *{
            ...
            '''
            ) if is_dark_theme else html.style(
                '''
            @import url('https://fonts.googleapis.com/css2?family=Recursive&display=swap');
